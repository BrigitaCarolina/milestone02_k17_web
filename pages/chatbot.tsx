...
export default function help() {
  return (
    <>
      ...
      <Layout>
        <div className="bg-gradient-to-b from-orange-400 to-yellow-300 min-h-screen px-4 md:px-10">
          <div className="container max-w-4xl m-auto py-10">
            <h1 className="text-3xl font-bold underline flex justify-center mb-4">CHATBOT</h1>
            <div className="bg-gradient-to-b from-white to-yellow-100 min-h-100 flex flex-col text-justify justify-center rounded-3xl p-8 md:p-12 gap-6">
              <h1 className="font-raya text-4xl text-center"> LINE CHATBOT </h1>
              <p className="font-thin font-inter text-md md:text-2xl">
              ...
              <ul className="font-inter text-left list-disc text-md md:text-2xl">
                <li>
              ...
              <a className="flex" href="https://liff.line.me/1645278921-kWRPP32q/?accountId=354kntnm" target="_blank"><button className="rounded-xl bg-sky-900 text-white text-2xl p-4 mx-auto hover:bg-sky-700">TAMBAHKAN SAH DI LINE</button></a>
